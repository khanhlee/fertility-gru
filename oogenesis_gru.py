...
################ PARAMETERS #################
train_positive_lst_file = "fertility.cv.list"
train_positive_dir = "fertility/cv/"
train_negative_lst_file = "non-fertility.cv.list"
train_negative_dir = "non-fertility/cv/"

val_positive_lst_file = "fertility.ind.list"
val_positive_dir = "fertility/ind/"
val_negative_lst_file = "non-fertility.ind.list"
val_negative_dir = "non-fertility/ind/"
...
def evaluate(loader, is_val=True):
    ...
    if is_val:
        ...
        acc, confusion_matrix, sensitivity, specificity = calculate_confusion_matrix(arr_labels, arr_labels_hyp)
        return epoch_loss_avg, acc, confusion_matrix, sensitivity, specificity
...
def calculate_confusion_matrix(arr_labels, arr_labels_hyp):
    ...
    return acc, confusion_matrix, sensitivity, specificity
...
def validation():
    ...
    epoch_loss_test_avg, test_acc, confusion_matrix, sensitivity, specificity = evaluate(test_loader, is_val=False)
